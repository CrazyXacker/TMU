...
public class JFXCustomDecorator extends VBox {
     ...
     */
    public JFXCustomDecorator(Stage stage, Node node, boolean fullScreen, boolean max, boolean min, boolean isDarkTheme) {
    ...
    private void initializeButtons() {
        ...
        btnLanguage = new JFXButton();
        btnLanguage.getStyleClass().add("jfx-decorator-button");
        btnLanguage.setCursor(Cursor.HAND);
        btnLanguage.setOnAction((action) -> onLanguageActionRunnable.run());
        btnLanguage.setFont(Font.font("System", FontWeight.BOLD, 14));
        btnLanguage.setStyle("-fx-text-fill: " + (isDarkTheme ? "#ffffff" : "#000000"));

        btnTheme = new JFXButton();
        btnTheme.getStyleClass().add("jfx-decorator-button");
        ...
        btnFull.setRipplerFill(Color.DARKGRAY);
        ...
        btnClose.setRipplerFill(Color.DARKGRAY);
    ...
    private void initializeContainers(Node node, boolean fullScreen, boolean max, boolean min) {
        ...
        text.setFill(isDarkTheme ? Color.WHITE : Color.BLACK);
    ...
    public void setLanguageText(String languageText) {
        btnLanguage.setText(languageText);
    }

    public void setOnLanguageActionRunnable(Runnable onLanguageActionRunnable) {
        this.onLanguageActionRunnable = onLanguageActionRunnable;
    }
